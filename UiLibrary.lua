...
function UILibrary:CreateWindow(title, size, position)
    ...
    contentFrame.CanvasSize = UDim2.new(0, 0, 0, 0)  -- Inicialização obrigatória!
    ...
    local windowObject = {
        ...
        AddToggle = function(self, text, default, callback)
            ...
            toggleButton.BackgroundColor3 = (default == true) and self.Theme.PrimaryColor or self.Theme.BackgroundColor
            toggleButton.Text = ""
        ...
        AddDropdown = function(self, text, options, default, callback)
            ...
            dropdownButton.MouseButton1Click:Connect(function()
                ...
                local height = #options * 27 + (#options - 1) * 2
                CreateTween(optionsFrame, {Size = expanded and UDim2.new(1, 0, 0, height) or UDim2.new(1, 0, 0, 0)})
            end)
        end
    }
